...
**New:** Now you can [run this miner on any stratum based pool](https://github.com/Cryolitecoin/coin-hive#faq).

**New 2:** Now you can [mine Electroneum (ETN)](https://github.com/Cryolitecoin/coin-hive#can-i-mine-other-cryptocurrency-than-monero-xmr).

**Need a proxy?** check [coin-hive-stratum](https://github.com/Cryolitecoin/coin-hive-stratum).
